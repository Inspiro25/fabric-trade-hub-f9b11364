                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={cn(
                      "text-sm font-medium",
                      isDarkMode ? "text-gray-300" : "text-gray-700"
                    )}>{product?.stock && product.stock > 0 ? 'In Stock' : 'Out of Stock'}</span>
                  </div>
                </div>
              </TabsContent>
                      ...
                      <div className="space-y-2">
                        {product?.specifications ? (
                          ...
                          <p className={cn(
                            "text-sm",
                            isDarkMode ? "text-gray-400" : "text-gray-500"
                          )}>No specifications available for this product.</p>
                        )}
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className={cn(
                              "text-xs",
                              isDarkMode ? "text-gray-400" : "text-gray-500"
                            )}>This item is eligible for free shipping on orders over ₹999.</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <Clock className={cn(
                          ...
                          <div>
                            ...
                            <p className={cn(
                              "text-xs",
                              isDarkMode ? "text-gray-400" : "text-gray-500"
                            )}>Estimated delivery time: 3-5 business days.</p>
                          </div>
                        </div>
                      </div>
                    </AccordionContent>
